...
<p align="justify">
I develop statistical methodology for reliable inference and uncertainty quantification in complex biomedical data. My work is motivated by settings where distribution shift, outcome heterogeneity, and imperfect measurements are unavoidable, including statistical genetics and genomics, epidemiology, electronic health records, and related applications. Methodologically, I focus on distributional and quantile-based modeling, robust learning under shift, and debiasing ideas from measurement error analysis, with an emphasis on interpretability and scalability.
</p>
...
<ol class="pub-list">
  ...
  <li value="36"><ins>Zhao, H.</ins> and <b>Wang, T.<span>&#x2709;</span></b> (2026+). <a href="https://arxiv.org/abs/2605.04469"><i>“Augmented transfer regression learning for completely missing covariates”.</i></a>
    <ul><li>An earlier version won the <b>2025 IMS Hannan Graduate Student Travel Award</b></li></ul>
  </li>
  
  <li value="35"><b>Wang, T.<span>&#x2709;</span></b> (2026+). <a href="https://arxiv.org/abs/2604.25202"><i>“Tail allocation for conformal prediction intervals”</i></a>.</li>
  ...
  <li value="32"><ins>Zhao, H.</ins> and <b>Wang, T.<span>&#x2709;</span></b> (2026+). <a href="https://arxiv.org/abs/2509.06118"><i>“A simulation-free extrapolation method for misspecified models with errors-in-variables in epidemiological studies”</i></a>.</li>
...
<ol class="pub-list">
  ...
  <li value="27"><b>Wang, T.<span>&#x2709;</span></b>, Ionita-Laza, I., and Wei, Y. (2025). <a href="https://projecteuclid.org/journals/annals-of-applied-statistics/volume-19/issue-2/A-unified-quantile-framework-for-nonlinear-heterogeneous-transcriptome-wide-associations/10.1214/24-AOAS1999.short">“A unified quantile framework for nonlinear heterogeneous transcriptome-wide associations”</a>, <b><i>Annals of Applied Statistics</i></b>, 19(2): 967–985.</li>
  <li value="26"><ins>Wang, Z.</ins>, Ling, W., and <b>Wang, T.<span>&#x2709;</span></b> (2025). <a href="https://doi.org/10.1093/biomtc/ujaf050">“A Semiparametric Quantile Regression Rank Score Test for Zero-inflated Data”</a>, <b><i>Biometrics</i></b>, 81(2), ujaf050.</li>
  <li value="25"><b>Wang, T.<span>&#x2709;</span></b>, Zhang, W., and Wei, Y. (2025). <a href="https://www3.stat.sinica.edu.tw/ss_newpaper/SS-2023-0107_na.pdf">“ZIKQ: An innovative centile chart method for utilizing natural history data in rare disease clinical development”</a>, <b><i>Statistica Sinica</i></b>, 35, 2451–2468.</li>
  <li value="24">Li, Y., <b>Wang, T.<span>&#x2709;</span></b>, Yan, J., and Zhang, X. (2025). <a href="https://journals.ametsoc.org/view/journals/clim/38/8/JCLI-D-24-0193.1.xml">“Improved Optimal Fingerprinting Based on Estimating Equations Reaffirms Anthropogenic Effect on Global Warming”</a>, <b><i>Journal of Climate</i></b>, 38(8), 1779–1790.</li>
    <li value="23"><b>Wang, T.</b>, Liu, J., and Wu, A. (2025). <a href="https://jds-online.org/journal/JDS/article/1391/info">“Semiparametric Analysis in Case-Control Studies for Gene-Environment Independent Models: Bibliographical Connections and Extensions”</a>, <b><i>Journal of Data Science</i></b>, 23(3): 454–469.</li>
  <li value="22"><ins>Luo, Q.<sup><span>&#9830;</span></sup></ins>, <ins>Yu, Y.<sup><span>&#9830;</span></sup></ins>, and <b>Wang, T.<span>&#x2709;</span></b> (2025). <a href="https://link.springer.com/article/10.1186/s12859-025-06296-w">“Denoising Single-Cell RNA-Seq Data with a Deep Learning-Embedded Statistical Framework”</a>, <b><i>BMC Bioinformatics</i></b>, 26, 282.</li>
  <li value="21"><ins>Mao, Y.</ins>, <ins>Jiang, Z.</ins>, <b>Wang, T.</b>, Hu, Y., and Zhan, X. (2025). <a href="https://doi.org/10.1093/bioinformatics/btaf617">“TCVS: Tree-guided compositional variable selection analysis of microbiome data”</a>, <b><i>Bioinformatics</i></b>, 41 (11), btaf617.</li>
    <li value="20">Wang, F., Wang, C., <b>Wang, T.</b>, Masala, M., Fiorillo, E., Devoto, M., Cucca, F., Ionita-Laza, I. (2025). <a href="https://www.pnas.org/doi/epdf/10.1073/pnas.2513007122">“Computationally efficient whole-genome quantile regression at biobank scale”</a>, <b><i>Proceedings of the National Academy of Sciences</i></b>, 122 (50), e2513007122.</li>
</ol>

### 2024
<ol class="pub-list">
  <li value="19"><ins>Zhao, H.</ins>, and <b>Wang, T.<span>&#x2709;</span></b> (2024). <a href="https://academic.oup.com/biometrics/article/80/4/ujae153/7925418">“A high-dimensional calibration method for log-contrast models subject to measurement errors”</a>, <b><i>Biometrics</i></b>, 80(4), ujae153.</li>
  <li value="18"><ins>Wang, Z.<sup><span>&#9830;</span></sup></ins> and <b>Wang, T.<span>&#x2709;</span></b> (2024). <a href="https://www3.stat.sinica.edu.tw/ss_newpaper/SS-2024-0104_na.pdf">“A Semiparametric Quantile Single-Index Model for Zero-Inflated Outcomes”</a>, <b><i>Statistica Sinica</i></b>, accepted.</li>
...
### 2020 and before
<ol class="pub-list">
  <li value="6">Gaynanova, I. and <b>Wang, T.</b> (2019). <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6516858/">“Sparse quadratic classification rules via linear dimension reduction”</a>. <b><i>Journal of Multivariate Analysis</i></b>, 169, 278–299.</li>
  <li value="5">Blas Achic, B.<sup><span>&#9839;</span></sup>, <b>Wang, T.<sup><span>&#9839;</span></sup></b>, Su, Y., Kipnis, V., Dodd, K., and Carroll, R. J. (2018). <a href="https://projecteuclid.org/euclid.ejs/1544518836">“Categorizing a Continuous Predictor Subject to Measurement Error”</a>. <b><i>Electronic Journal of Statistics</i></b>, 12(2), 4032–4056. (<sup><span>&#9839;</span></sup> joint first authors).</li>
  <li value="4">Li, H., Staudenmayer, J., <b>Wang, T.</b>, Keadle, S. K., and Carroll, R. J. (2018). <a href="https://www.ncbi.nlm.nih.gov/pubmed/29052239">“Three-part joint modeling methods for complex functional data mixed with zero-and-one–inflated proportions and zero‐inflated continuous outcomes with skewness”</a>. <b><i>Statistics in Medicine</i></b>, 37(4), 611–626.</li>
  <li value="3">Johnson, V., Payne, R., <b>Wang, T.</b>, Asher, A., and Mandal, S. (2017). <a href="https://amstat.tandfonline.com/doi/abs/10.1080/01621459.2016.1240079#.WqQ13ZPwbOQ">“On the reproducibility of psychological science”</a>. <b><i>Journal of the American Statistical Association</i></b>, 112(517): 1–10.</li>
