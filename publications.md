...
- Wang, C., **Wang, T.**, Wei, Y., Aschard, H., and Ionita-Laza, I. (2024). ["Genome-wide discovery for biomarkers using quantile regression at biobank scale"](), **_Nature Communications_**, to appear.
